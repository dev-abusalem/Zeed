...
//Remove Item / حذف هذا المرفقs form input field 1
...
//Remove Item / حذف هذا المرفقs form input field 2
...
//Remove Item / حذف هذا المرفقs form input field 3
...
//Remove Item / حذف هذا المرفقs form input field 4
...
//Remove Item / حذف هذا المرفقs form input field 5
  ...
  return (
    ...
    <div className="login pt-5">
      <div className="singupbg min-h-screen m-3 flex flex-col items-center justify-center text-white">
        ...
        <div className="font-medium self-center text-xl sm:text-2xl uppercase underline text-white">Establishment SIGN UP
        </div>
    <div>
    ...
    <form action="#" onSubmit={handleSubmit}>
      ...
      <div className="flex flex-col mb-3">
        ...
        <div className="flex flex-col mb-6">
        <div className='flex justify-between items-center'>
            <label htmlFor="" className="mb-1 text-xs sm:text-sm tracking-wide text-white">Bank Name</label>
            <label htmlFor="bname" className="mb-1 text-xs sm:text-sm tracking-wide text-white">اسم البنك</label>
        </div> 
        ...
        <div className="relative">
            ...
            <select id="bname" type="tel" name="bname" className="text-sm sm:text-base placeholder-gray-500 pl-10 pr-4 rounded-lg border border-gray-400 w-full py-2 bg-colone text-white focus:outline-none focus:border-white" placeholder="Bank Name" >
        ...
        <div className="flex flex-col mb-6">
        <div className='flex justify-between items-center'>
            <label htmlFor="" className="mb-1 text-xs sm:text-sm tracking-wide text-white">Bank account holder name
</label>
            <label htmlFor="bacn" className="mb-1 text-xs sm:text-sm tracking-wide text-white">اسم الحساب
</label>
        </div> 
        ...
        <div className="relative">
            ...
            <input id="bacn" pattern='[0-9]+' type="text" name="bacn" className="text-sm sm:text-base placeholder-gray-500 pl-10 pr-4 rounded-lg border bg-colone border-gray-400 w-full py-2 focus:outline-none focus:border-white" placeholder="Bank account holder name" />
        </div>
        </div>
        ...
        <div className="relative">
            ...
            <input  ref={fileInputRef3} onChange={handleFileChange3}  id="clicence" type="file" name="clicence" className="text-sm sm:text-base placeholder-gray-500 pl-10 pr-4 rounded-lg border bg-colone border-gray-400 w-full py-2 focus:outline-none focus:border-white" placeholder="Signature Authorization" />
        </div>
        ...
        <div className="relative">
            ...
            <input  ref={fileInputRef5} onChange={handleFileChange5}   id="insta" type="file" name="insta" className="text-sm sm:text-base placeholder-gray-500 pl-10 pr-4 rounded-lg border bg-colone border-gray-400 w-full py-2 focus:outline-none focus:border-white" placeholder="Instagram (Instagram account screenshot)" />
        </div>
