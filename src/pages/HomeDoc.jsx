  ...
  return (
    ...
    <div className="login  pt-5">
      <div className="singupbg min-h-screen m-3 flex flex-col items-center justify-center text-white">
        ...
        <div className="font-medium self-center text-xl sm:text-2xl uppercase underline text-white">Home Business
 SIGN UP
        </div>
    <div>
    ...
    <form action="#" onSubmit={handleSubmit}>
      ...
      <div className="flex flex-col mb-3">
        ...
        <div className="relative">
            ...
            <input  ref={fileInputRef} onChange={handleFileChange} id="civilidf" type="file" name="civilidf" className="text-sm sm:text-base placeholder-gray-500 pl-10 pr-4 rounded-lg border bg-colone border-gray-400 w-full py-2 focus:outline-none focus:border-white" placeholder="Civil ID of Manager (Front)" />
        </div>
        ...
        <div className="flex flex-col mb-6">
        <div className='flex justify-between items-center'>
            <label htmlFor="" className="mb-1 text-xs sm:text-sm tracking-wide text-white">Bank Account Letter
            </label>
            <label htmlFor="ownerid" className="mb-1 text-xs sm:text-sm tracking-wide text-white">خطاب حساب بنكي  
            </label>
        </div> 
        ...
        <div className="relative">
            ...
            <input  ref={fileInputRef3} onChange={handleFileChange3} id="ownerid" type="file" name="ownerid" className="text-sm sm:text-base placeholder-gray-500 pl-10 pr-4 rounded-lg border bg-colone border-gray-400 w-full py-2 focus:outline-none focus:border-white" placeholder="Bank Account Letter" />
        </div>
        ...
        <div className="relative">
            ...
            <input  ref={fileInputRef4} onChange={handleFileChange4} id="insta" type="file" name="insta" className="text-sm sm:text-base placeholder-gray-500 pl-10 pr-4 rounded-lg border bg-colone border-gray-400 w-full py-2 focus:outline-none focus:border-white" placeholder="Instagram (Instagram account screenshot)" />
        </div>
